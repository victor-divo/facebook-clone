...
;(function (global, factory) {
    ...
    utils_hooks__hooks.defaultFormat = 'YYYY-MM-DDTHH:mmZ';
    utils_hooks__hooks.defaultFormatUtc = 'YYYY-MM-DDTHH:mm[Z]';

    function toString () {
        return this.clone().locale('en').format('ddd MMM DD YYYY HH:mm [GMT]ZZ');
    }
    ...
    function moment_format__toISOString () {
        ...
        if (0 < m.year() && m.year() <= 9999) {
            if (isFunction(Date.prototype.toISOString)) {
                ...
                return formatMoment(m, 'YYYY-MM-DD[T]HH:mm.SSS[Z]');
            }
        } else {
            return formatMoment(m, 'YYYYYY-MM-DD[T]HH:mm.SSS[Z]');
        }
    }
